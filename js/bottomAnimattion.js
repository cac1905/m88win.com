...
cnGame.register("cnGame.collision",function(cg){
	...
	**/	
	...
	this.col_Between_Rects=function(rectObjA,rectObjB){
		return ((rectObjA.right>(rectObjB.x-70)&&rectObjA.right<(rectObjB.right-70)||rectObjA.x>rectObjB.x&&rectObjA.x<rectObjB.right)&&(rectObjA.bottom>rectObjB.y&&rectObjA.bottom<rectObjB.bottom||rectObjA.y<rectObjB.bottom&&rectObjA.bottom>rectObjB.y));		
	}
	/**
	 *点和圆形间的碰撞
	**/	
